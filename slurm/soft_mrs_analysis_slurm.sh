...
#SBATCH -p longtime 
#SBATCH -J "Soft-MRS Analysis" # gives SLURM_JOB_NAME
...
CONFIG=soft_mrs_analysis.config
...
srun python ../src/soft_mrs_analysis.py --data_set_name $DATASET --bias_type $BIAS_TYPE --n_cv_repeats $N_CV_REPEATS --n_cv_splits $N_CV_SPLITS \
